...
const key_override_t delete_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DELETE, ~_HALMAK | ~_NAV | ~_QWERTY);
...
const uint16_t PROGMEM qwerty_layer_combo[] = {KC_T, KC_O, COMBO_END};

const uint16_t PROGMEM osl_halmak_layer_combo[] = {KC_T, KC_N, KC_A, COMBO_END};
const uint16_t PROGMEM osl_nav_layer_combo[] = {KC_T, KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM osl_qwerty_layer_combo[] = {KC_T, KC_N, KC_O, COMBO_END};

combo_t key_combos[] = {
    COMBO(halmak_layer_combo, TO(_HALMAK)),
    COMBO(nav_layer_combo, TO(_NAV)),
    COMBO(qwerty_layer_combo, TO(_QWERTY)),
    COMBO(osl_halmak_layer_combo, OSL(_HALMAK)),
